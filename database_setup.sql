...
-- Create Demand Orders table
CREATE TABLE IF NOT EXISTS demand_orders (
    id INT AUTO_INCREMENT PRIMARY KEY,
    serial_no INT,
    group_demand_no VARCHAR(255),
    demand_date DATE,
...
CREATE TABLE IF NOT EXISTS sanction_gen_project (
    id INT AUTO_INCREMENT PRIMARY KEY,
    serial_no INT,
    date DATE,
    file_no VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS sanction_misc (
    id INT AUTO_INCREMENT PRIMARY KEY,
    serial_no INT,
    date DATE,
    file_no VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS sanction_training (
    id INT AUTO_INCREMENT PRIMARY KEY,
    serial_no INT,
    date DATE,
    file_no VARCHAR(255),
...
INSERT INTO supply_orders (serial_no, supply_order_no_date, firm_name, nomenclature, quantity, original_date, revised_date1, build_up, maint, misc, project_no_pdc, p_np, expenditure_head, rev_cap, actual_delivery_date, procurement_mode, delivery_done, remarks, financial_year) VALUES
(1, 'SO/2024/001 - 15/01/2024', 'ABC Industries Ltd', 'Computer Hardware Set', '50 Units', '2024-03-15', '2024-04-15', 250000.00, 50000.00, 25000.00, 'PDC-2024-001', 'P', 'Office Equipment', 'R', '2024-04-20', 'Direct Purchase', 'Completed', 'All items delivered successfully', '2024-2025'),
(2, 'SO/2024/002 - 20/01/2024', 'XYZ Corporation', 'Network Infrastructure', '1 Lot', '2024-04-01', '2024-05-01', 500000.00, 100000.00, 50000.00, 'PDC-2024-002', 'P', 'IT Infrastructure', 'C', '2024-05-15', 'Tender', 'In Progress', 'Installation ongoing', '2024-2025'),
(3, 'SO/2024/003 - 25/01/2024', 'Tech Solutions Pvt Ltd', 'Software Licenses', '100 Licenses', '2024-03-01', NULL, 300000.00, 0.00, 15000.00, 'PDC-2024-003', 'NP', 'Software', 'R', NULL, 'GeM Portal', 'Pending', 'Awaiting delivery', '2024-2025'),
(4, 'SO/2024/004 - 30/01/2024', 'Engineering Works Ltd', 'Building Materials', '500 Bags', '2024-05-01', '2024-06-01', 150000.00, 30000.00, 10000.00, 'PDC-2024-004', 'P', 'Construction', 'C', '2024-06-10', 'Limited Tender', 'Completed', 'Quality approved', '2024-2025'),
(5, 'SO/2024/005 - 05/02/2024', 'Medical Supplies Co', 'Medical Equipment', '20 Units', '2024-04-15', NULL, 800000.00, 40000.00, 20000.00, 'PDC-2024-005', 'P', 'Medical', 'R', NULL, 'Direct Purchase', 'In Progress', 'Testing phase', '2024-2025'),
(6, 'SO/2024/006 - 10/02/2024', 'Vehicle Manufacturers', 'Official Vehicles', '5 Units', '2024-06-01', '2024-07-01', 2500000.00, 125000.00, 50000.00, 'PDC-2024-006', 'P', 'Transport', 'C', NULL, 'Tender', 'Pending', 'Under evaluation', '2024-2025'),
(7, 'SO/2024/007 - 15/02/2024', 'Furniture House', 'Office Furniture', '200 Items', '2024-03-30', '2024-04-30', 400000.00, 20000.00, 15000.00, 'PDC-2024-007', 'NP', 'Furniture', 'R', '2024-05-05', 'GeM Portal', 'Completed', 'Installation done', '2024-2025'),
(8, 'SO/2024/008 - 20/02/2024', 'Security Systems Ltd', 'CCTV System', '1 Lot', '2024-05-15', NULL, 350000.00, 35000.00, 25000.00, 'PDC-2024-008', 'P', 'Security', 'C', NULL, 'Limited Tender', 'In Progress', 'Installation started', '2024-2025'),
(9, 'SO/2024/009 - 25/02/2024', 'Stationery Suppliers', 'Office Supplies', '1000 Items', '2024-03-20', NULL, 75000.00, 5000.00, 8000.00, 'PDC-2024-009', 'NP', 'Stationery', 'R', '2024-04-01', 'Direct Purchase', 'Completed', 'Regular supply', '2024-2025'),
(10, 'SO/2024/010 - 01/03/2024', 'Power Solutions Inc', 'UPS Systems', '15 Units', '2024-04-20', '2024-05-20', 450000.00, 45000.00, 22500.00, 'PDC-2024-010', 'P', 'Power Equipment', 'C', NULL, 'Tender', 'Pending', 'Technical evaluation', '2024-2025');

-- Insert dummy data for Demand Orders
INSERT INTO demand_orders (serial_no, group_demand_no, demand_date, mmg_control_no, control_date, nomenclature, quantity, expenditure_head, code_head, rev_cap, procurement_mode, est_cost, imms_control_no, remarks, financial_year) VALUES
(1, 'GD/2024/001', '2024-01-10', 'MMG/2024/001', '2024-01-15', 'Desktop Computers', '25 Units', 'Office Equipment', 'OE001', 'R', 'Direct Purchase', 375000.00, 'IMMS/2024/001', 'Urgent requirement for new office', '2024-2025'),
(2, 'GD/2024/002', '2024-01-15', 'MMG/2024/002', '2024-01-20', 'Air Conditioning Units', '10 Units', 'Infrastructure', 'INF001', 'C', 'Tender', 500000.00, 'IMMS/2024/002', 'Summer preparation', '2024-2025'),
(3, 'GD/2024/003', '2024-01-20', 'MMG/2024/003', '2024-01-25', 'Printing Papers', '500 Reams', 'Stationery', 'ST001', 'R', 'GeM Portal', 25000.00, 'IMMS/2024/003', 'Regular consumption', '2024-2025'),
(4, 'GD/2024/004', '2024-01-25', 'MMG/2024/004', '2024-02-01', 'Vehicle Maintenance', '1 Lot', 'Transport', 'TR001', 'R', 'Annual Contract', 150000.00, 'IMMS/2024/004', 'Annual maintenance contract', '2024-2025'),
(5, 'GD/2024/005', '2024-02-01', 'MMG/2024/005', '2024-02-05', 'Security Services', '12 Months', 'Security', 'SEC001', 'R', 'Tender', 600000.00, 'IMMS/2024/005', 'Round the clock security', '2024-2025'),
(6, 'GD/2024/006', '2024-02-05', 'MMG/2024/006', '2024-02-10', 'Medical Equipment', '5 Units', 'Medical', 'MED001', 'C', 'Limited Tender', 750000.00, 'IMMS/2024/006', 'Hospital upgrade', '2024-2025'),
(7, 'GD/2024/007', '2024-02-10', 'MMG/2024/007', '2024-02-15', 'Training Materials', '100 Sets', 'Training', 'TR002', 'R', 'Direct Purchase', 50000.00, 'IMMS/2024/007', 'Staff development program', '2024-2025'),
(8, 'GD/2024/008', '2024-02-15', 'MMG/2024/008', '2024-02-20', 'Laboratory Equipment', '20 Items', 'Scientific', 'SCI001', 'C', 'Tender', 1200000.00, 'IMMS/2024/008', 'Research facility setup', '2024-2025'),
(9, 'GD/2024/009', '2024-02-20', 'MMG/2024/009', '2024-02-25', 'Cleaning Supplies', '12 Months', 'Maintenance', 'MNT001', 'R', 'Annual Contract', 80000.00, 'IMMS/2024/009', 'Facility maintenance', '2024-2025'),
(10, 'GD/2024/010', '2024-02-25', 'MMG/2024/010', '2024-03-01', 'Communication Equipment', '15 Units', 'Communication', 'COM001', 'C', 'GeM Portal', 300000.00, 'IMMS/2024/010', 'Network enhancement', '2024-2025');
...
-- Add constraints for data integrity (only for Rev/Cap field)
